...
def splitData(data, targets, filenames):
...
def trainModel(trainImages, trainTargets, testData, testTargets):
...
if __name__ == "__main__":
    data, targets, filenames = loadData()
    trainImages, testImages, trainTargets, testTargets, trainFilenames, testFilenames = splitData(data, targets, filenames)
    trainModel(trainImages, trainTargets, testImages, testTargets)
